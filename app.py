...
# ── SIVUN ALUSTUS (TÄYTYY OLLA ENNEN MUUTA KODEA) ──────────────────
...
def lataa_data():
    if os.path.exists(DATA_FILE):
        try:
            ...
            pass # Jos tiedosto korruptoitunut, palauta oletusdata
    return {
...
def laske_putki(nimi):
    """Laskee peräkkäiset päivät. Antaa armoa kuluvalle päivälle."""
    paivat = set()
    ...
    # Jos tälle päivälle ei ole vielä merkintää, aloitetaan eilisestä, jotta putki ei katkea turhaan kesken päivän

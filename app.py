...
with tab_vanhempi:
    ...
    if not st.session_state.vanhempi_kirjautunut:
        ...
        # ── 📈 VIIKKORAPORTTI ───────────────────────────────────────
        with st.expander("Viikkoraportti", expanded=False):
        ...
        # ── 💰 PELIAJAN KÄYTTÖ + SALDOJEN NOLLAUS ─────────────────
        with st.expander("Peliajan käyttäminen", expanded=False):
            kaikki_lapset = lapset()
            if kaikki_lapset:
                ...
                st.caption("Käytännöllistä esim. viikon vaihtuessa — nollaa kaikkien saldot yhdellä kertaa.")
        ...
        # ── 🔑 PIN-KOODIT ───────────────────────────────────────────
        with st.expander("Vaihda PIN-koodit", expanded=False):
        ...
        # ── ⚙️ ASETUKSET ────────────────────────────────────────────
        with st.expander("Asetukset", expanded=False):
        ...
        # ── 👦 LASTEN HALLINTA ──────────────────────────────────────
        with st.expander("Lapset", expanded=False):
            kaikki_lapset = lapset()
        ...
        # ── 🛠️ TEHTÄVÄHALLINTA ──────────────────────────────────────
        with st.expander("Tehtävät", expanded=False):
